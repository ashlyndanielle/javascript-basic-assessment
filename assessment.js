...
*/
function outside(numT, numH, numC){
	if (numT > 80 && numH < 40 && numC < 20){
		return "I'm literally in the desert";
	} else if (numT < 40 && numC > 60){
		return "I have icecicles";
	} else if (numT > 80 && numH > 40){
		return "I'm all sweat";
	} else if (numT > 80 || numH > 50 || numC > 50){
